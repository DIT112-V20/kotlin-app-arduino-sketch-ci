...
Group20Esp32WebServer::Group20Esp32WebServer(WebServer& webServer)
...
void Group20Esp32WebServer::on(const char* endpoint,
...
void Group20Esp32WebServer::send(int errorCode,
                                 const char* type,
                                 const char* payload)
{
